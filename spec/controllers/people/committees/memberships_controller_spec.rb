...
RSpec.describe People::Committees::MembershipsController, vcr: true do
  ...
  describe 'GET index' do
    ...
    it 'assigns @person, @letters and @committee_memberships' do
  ...
  describe 'GET current' do
    before(:each) do
      get :current, params: { person_id: 'Kz7ncmrt' }
    end
      ...
      methods = [
          {
            ...
            data_url: "#{ENV['PARLIAMENT_BASE_URL']}/person_committees_memberships_index?person_id=7KNGxTli"
          },
          {
            route: 'current',
            parameters: { person_id: '7KNGxTli' },
            data_url: "#{ENV['PARLIAMENT_BASE_URL']}/person_current_committees_memberships?person_id=7KNGxTli"
          }
        ]
