...
RSpec.describe 'parliaments/houses/parties/members/a_to_z', vcr: true do
  before do
  ...
  context 'header' do
    context 'MPs' do
      ...
      it 'will render the correct header' do
        expect(rendered).to match(/Green Party - MPs/)
      end
    end
    ...
    context 'Lords' do
      ...
      it 'will render the correct header' do
        expect(rendered).to match(/Green Party - Lords/)
      end
    end
